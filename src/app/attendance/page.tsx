...
const nav = [
  { label: "OmniTeam home", icon: LayoutDashboard, href: "/" },
  { label: "OmniAthlete", icon: Users, href: "/omniathlete" },
  { label: "Attendance", icon: ClipboardCheck, active: true, href: "/attendance" },
  { label: "My family", icon: Users, href: "/my-family" },
...
export default function Home() {
  ...
  return <main className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom"><Link href="/team/access"><Settings2 size={18} />Team access</Link><div className="profile"><div className="profile-avatar">JD</div><div><b>Demo account</b><small>Sample data</small></div><MoreHorizontal size={17} /></div></div>
    </aside>
    <section className="content">
      ...
      <div className="page-wrap">
        <p className="attendance-demo-note">Demo screen: these swimmers and attendance changes are sample data and are not saved to Supabase. <Link href="/omniathlete">Explore OmniAthlete</Link></p>
        ...
        <div className="section-heading"><div><h2>Mark attendance</h2><p className="muted">Try the sample controls. Changes stay on this page only.</p></div><div className="save-state"><span className={saved ? "saved-dot" : "saving-dot"} />{saved ? "Demo changes only" : "Updating demo..."}</div></div>
