...
-- Phase 3 visible meet on the same OmniSchedule calendar.
insert into public.events(id,org_id,team_id,title,starts_at,ends_at,location,visibility,kind,commit_deadline,status,created_by)
values('16000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002','Fall Splash Invitational','2026-10-10 08:00-07','2026-10-10 17:00-07','Bay City Aquatic Center','members','meet','2026-10-02 20:00-07','published','11000000-0000-0000-0000-000000000004');
