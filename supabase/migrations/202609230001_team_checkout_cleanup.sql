-- Completed mock checkout records reference their provisioned team. Include them
-- in the existing team cleanup path so explicit hard deletion cannot be blocked.
